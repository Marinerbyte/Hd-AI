...
def start_bot_logic():
    ...
    if not bot_thread or not bot_thread.is_alive():
        ...
        bot_state = BotState()
        load_masters() # <-- FIX: Reload masters list when bot is started from panel
...
# UPDATED load_masters function
def load_masters():
    masters_str = Config.MASTERS_LIST
    if masters_str:
        # This new logic correctly handles spaces and trailing commas
