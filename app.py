...
# ========================================================================================
# === 8. ARSENAL CLASH GAME LOGIC (UPGRADED) =============================================
# ========================================================================================
...
def handle_game_turn(sender, room_id, move):
    ...
    with game_state_lock:
        if not active_duels.get(game_state["duel_id"]): return # Game might have ended
        ...
        # --- DEFENDER'S TURN ---
            ...
            # This will start the next attacker's timer
            threading.Thread(target=advance_turn, args=(duel_id,)).start()
...
def handle_game_command(sender, room_id, command, args):
    ...
    with game_state_lock:
        if command == "duel":
            ...
            # Check if sender has already issued a challenge
            ...
            challenger_info['expiry_timer'].cancel() # IMPORTANT: Cancel the expiry timer
            ...
            time.sleep(1)
            # Advance turn will start the first turn and its timer
            threading.Thread(target=advance_turn, args=(duel_id,)).start()
