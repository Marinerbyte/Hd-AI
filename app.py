...
# ========================================================================================
# === 6. AI & COMMANDS (MODIFIED: NO LONG-TERM MEMORY) ===================================
# ========================================================================================
...
### --- MODIFIED START --- ###
# The `update_user_facts` function has been completely removed.
...
def get_ai_response(user_message, sender, room_id):
    ...
    try:
        # Long-Term Memory (user_facts) step is now removed.
        ...
        # 2. Construct the full System Prompt (now without long-term memory)
        full_system_prompt = personality_prompt
        
        # 3. Fetch Short-Term Memory (Recent Conversation)
        ...
        # 4. Call Groq for the main response
        ...
        # The background thread to update long-term memory is removed.
