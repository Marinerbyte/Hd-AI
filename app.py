            ...
            try:
                ...
                while self.should_run:
                    ...
                    # <-- YAHAN SABSE ZAROORI BADLAV KIYA GAYA HAI ---
                        ...
                        if room_id and name:
                            with self.room_data_lock:
                                # Sirf room add karo, users ki list ka intezaar karo
                                self.current_rooms[room_id] = {"name": name, "users": []}
                            
                            room_names_list = [r['name'] for r in self.current_rooms.values()]
                            self.log(f"SUCCESS: Room '{name}' join kar liya. User list ka intezaar hai. Current rooms: {room_names_list}")
